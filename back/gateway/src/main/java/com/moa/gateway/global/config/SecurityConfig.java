	...
	public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
		return http.httpBasic(httpBasic -> httpBasic.disable()) // HTTP Basic 인증 비활성화
			...
			.authorizeExchange(exchanges -> exchanges.pathMatchers("/api/moapay/member/login", "/api/moapay/member/join",
					...
					"/moapay/pay/analysis/history", "/api/moapay/pay/analysis/history","/moapay/core/code/QRcode", "/api/moapay/core/code/QRcode", "/moapay/core/generalpay/offline","/moapay/pay/notification/subscribe/**"
							)
				.permitAll()
				.anyExchange()
