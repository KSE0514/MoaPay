        ...
        <ProcessContainer>
          ...
          <Process>
            ...
            >
              <div
                style={{
                  backgroundColor: process === 0? "#8748F3": (0 < process ? "black": "white")
                }}
              ></div>
              <div>시작 대기</div>
            </Step>
            ...
            >
              <div
                style={{
                  backgroundColor: process === 1? "#8748F3": (1 < process ? "black": "white")
                }}
              ></div>
              <div>금액 산정</div>
            </Step>
            ...
            >
              <div
                style={{
                  backgroundColor: process === 2? "#8748F3": (2 < process ? "black": "white")
                }}
              ></div>
              <div>결제</div>
            </Step>
